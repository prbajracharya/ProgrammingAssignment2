...
# The cacheSolve computes the inverse of a matrix created with the above function.
# It first checks to see if the inverse has already been calculated.
# If so then it gets the inverse from the cache and skips the computation else it will calculate the inverse.
